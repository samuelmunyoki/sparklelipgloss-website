                        ...
                        <div class="row">
                                ...
                                <div class="card bg-primary text-white mb-4">
                                   <div class="row text-center">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white " href="{{ route('adminhome') }}">View Details</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="row text-center">
                                       <div class=""><h4>Popular Items</h4></div>
                                       <div >
                                           @if(session()->has('no_popular'))
                                            {{ session('no_popular') }}
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white " href="{{ route('adminpopular') }}">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="row text-center">
                                       <div class=""><h4>New Arrivals</h4></div>
                                       <div >
                                           @if(session()->has('no_new'))
                                            {{ session('no_new') }}
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="{{ route('adminnew-arrivals') }}">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                   <div class="row text-center">
                                    <div class=""><h4>Users Online</h4></div>
                                    <div >
                                          @if(session()->has('users_online'))
                                            {{ session('users_online') }}
    
                                        @endif
                                       </div>
                                       </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="{{ route('adminusers') }}">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                         ...
                         @if(Request::is('/admin'))
                            {{  $orders->onEachSide(3)->links('pagination::bootstrap-4') }}
                             ...
                             @elseif(Request::is('/admin/users'))
                               {{  $users->onEachSide(3)->links('pagination::bootstrap-4') }}   
                         @endif
